      ...
      <div>
        ...
        <ul>
          <li>
            ...
            respective group. Due date for your stage 1 picks is 11/19/22.
          </li>
          <li className="margin-top">
            Stage 2 - Complete a round of 16 bracket. We won't know every team
            that is advancing to the round of 16 until the afternoon of 12/2/22.
          ...
          <li className="important">
            ** If you do not make your Knockout picks by the time the first
            Knockout game starts on 12/3/22, your Knockout picks will be null,
            and you will not recieve any points for this stage. **
          </li>
        </ul>
