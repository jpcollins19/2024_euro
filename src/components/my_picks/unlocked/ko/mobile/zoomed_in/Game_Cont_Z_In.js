...
const Game_Cont_Z_In = ({side, region, gameNum, user, resetMasterError}) => {
    const game = gameMapper_ko_edit[side][region][gameNum];
    const teamsPlayingInMatch = user[game];

    const game_set = setTeamMapper_ko_edit[side][region][gameNum];
