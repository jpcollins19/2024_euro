        ...
        try {
            ...
            if (joe?.tourneyStage === 1) {
                ...
                if (thirdPlaceToAdvanceAudit.error) {
                    thirdPlaceToAdvanceAudit.groupErrorList.forEach(
                        ( letter ) => {
                            const setError = eval(`setGroup${letter}Error`);
            ...
            !masterError &&
            !errorAudit.length &&
            dispatch(updateUser(userObj, history, routes.myPicks));
        } catch (err) {
            ...
            {loading ? (
                ...
                >
                    <div className="my-picks-ul-top">
                        ...
                        <Cancel link={routes.myPicks} color="black"
                                bold={true}/>
                        ...
                        {joe?.tourneyStage === 1 && (
                            <div
                                className="tiebreaker-cont-edit-picks black-text">
                                <h3>Tiebreaker - total number of goals
                                    scored:</h3>
